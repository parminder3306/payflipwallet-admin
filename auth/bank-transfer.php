...
$query .= "SELECT * FROM banktransfer ";
...
$query1 = "SELECT * FROM banktransfer";
...
if($source == "edit"){
$update="update orders set status='Success' where orderid='".$_POST['orderid']."'" ;
$update1="update banktransfer set status='Success' where orderid='".$_POST['orderid']."'" ;
if(mysqli_query($sp, $update) &&  mysqli_query($sp, $update1)){
echo "success";
}else{
echo "!error";	
}	
}
if($source == "details" && isset($_POST["orderid"])){
...
if(mysqli_query($sp,"update banktransfer set status='Refund' where orderid='$orderid'"));
...
if($source == "delete"){
$query = "DELETE FROM banktransfer WHERE orderid = '".$_POST['orderid']."'";
