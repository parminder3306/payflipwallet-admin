...
<div class="container">
   <div class="table-responsive">
    <table id="banktransfer" class="table table-bordered table-striped">
     <thead>
      <tr>
       <th data-column-id="orderid" data-type="numeric">ORDERID</th>
       <th data-column-id="holder">HOLDER NAME</th>
	   <th data-column-id="acnumber">ACCOUNT NO.</th>
	   <th data-column-id="ifsc">IFSC CODE</th>
...
var base_url ="auth/bank-transfer.php";

 
 var productTable = $('#banktransfer').bootgrid({
  ajax: true,
  rowSelect: true,
  post: function()
  {
  ...
  formatters: {
   "commands": function(column, row)
   {
    ...
    return "<button type=\"button\" disabled class=\"btn btn-success btn-xs refund\">Refund</button>" + 
    "&nbsp; <button type=\"button\" disabled class=\"btn btn-success btn-xs success\">Success</button>" +
    "&nbsp; <button type=\"button\" class=\"btn btn-danger btn-xs delete\" data-row-id=\""+row.orderid+"\">DELETE</button>";
   }else{
	  return "<button type=\"button\" class=\"btn btn-success btn-xs refund\" data-row-id=\""+row.orderid+"\">Refund</button>" + 
    "&nbsp; <button type=\"button\" class=\"btn btn-success btn-xs edit\" data-row-id=\""+row.orderid+"\">Success</button>" +
    "&nbsp; <button type=\"button\" class=\"btn btn-danger btn-xs delete\" data-row-id=\""+row.orderid+"\">DELETE</button>";   
   }
   }
  }
