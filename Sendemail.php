...
<div class="container">
   <div align="right">
    <button type="button" id="allbtn" data-toggle="modal" data-target="#all" class="mybtn_small">All EMAILS</button>
   </div>
   <div class="table-responsive">
    <table id="sendemails" class="table table-bordered table-striped">
     <thead>
      <tr>
...
var base_url ="auth/sendemails.php";

 $('#allbtn').click(function(){
  $('#all_form')[0].reset();
 }); 
 
 var productTable = $('#sendemails').bootgrid({
  ajax: true,
  rowSelect: true,
  post: function()
  {
  ...
  formatters: {
   ...
   {
    return "<button type=\"button\" class=\"btn btn-success btn-xs singleform\"  data-row-id=\""+row.email+"\">SEND EMAIL</button>";
   }
  }
 });
  ...
  <form method="post" id="all_form">
   <div class="modal-content">
    <div class="modal-header">
     ...
     <h4 class="modal-title">Email Management: All</h4>
    </div>
 ...
 <div class="modal-dialog">
  <form method="post" id="single_form">
   <div class="modal-content">
    <div class="modal-header">
     <button type="button" class="close" data-dismiss="modal">&times;</button>
     <h4 class="modal-title">Email Management: Single</h4>
    </div>
  <div class="modal-body">
     <label>Title</label>
     <input type="text" name="title" id="stitle" />
	 <label>Message</label>
      <textarea name="message" id="smessage"></textarea>
