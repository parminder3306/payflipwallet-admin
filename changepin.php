<?php
require_once('auth/changepin.php');
?>
<!DOCTYPE html>
<html lang='en-US'>
<head>
...
<input type="text" name="oldpin" id="oldpin" maxlength="4" value="<?php if(isset($oldpin)){ echo $oldpin;}?>" placeholder="Old PIN">
<input type="text" name="newpin" id="newpin" maxlength="4" value="<?php if(isset($newpin)){ echo $newpin;}?>" placeholder="New PIN">
